...
getgenv().SailorPieceConfig = {
    ...
    AutoReroll       = false,          -- Auto dùng Race/Clan Reroll
    TargetRace       = "Kitsune",     -- Race mục tiêu (dừng khi đạt)
    TargetClan       = "Monarch",     -- Clan mục tiêu (dừng khi đạt)
    AutoTraitReroll  = false,          -- Auto reroll trait đến khi đạt rarity mục tiêu
    ...
    FPSLock          = 10,            -- Khóa FPS 
    HideMobVFX       = false,           -- Ẩn hiệu ứng chiêu thức/vũ khí của mob & boss
}
